...
class IronCondorScoringConfig:
    min_vertical_credit: float = 0.15
    ...
    check_center_score: bool = True
    check_delta_balance: bool = True

    missing_delta_score: float = 0.1
    missing_centering_score: float = 0.1
